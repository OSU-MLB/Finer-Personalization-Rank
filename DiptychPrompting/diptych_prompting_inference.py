...
def grounded_segmentation(
    ...
    detections = detect(detect_pipeline, image, device, labels, threshold, detector_id)
    detections = segment(segmentator, segment_processor, image, device, detections, polygon_refinement)
